...
public class Rectangle {
	...
	/**
	 * Create a rectangle from the given parameters All numbers must be positive
	 * 
	 * @param x
	 *            - the top left
	 * @param y
	 *            - the top left
	 * @param width
	 *            - change in the positive x direction
	 * @param height
	 *            - change in the positive y direction
	 */
	...
	/**
	 * Checks whether this rectangle contains the upper left and lower right
	 * corners of other
	 * 
	 * @param other
	 * @return
	...
	public boolean contains(Rectangle other) {
		return this.contains(other.getX(), other.getY())
				&& this.contains(other.getX() + other.getWidth(), other.getY()
						+ other.getHeight());
	}
	...
	public boolean overlaps(Rectangle other) {
		return !((this.y + this.height) < other.getY()
				...
				|| (this.x + this.width) < other.getX() || this.x > (other
				.getX() + other.getWidth()));
	}
	...
	public String toString() {
		return "Rectangle: (" + x + "," + y + ") width: " + width + ", height:"
				+ height;
	}
